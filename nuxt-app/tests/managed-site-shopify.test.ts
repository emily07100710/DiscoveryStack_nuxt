...
async function makeProject() {
  ...
  const quote = await createManagedSiteQuote({ previewId: preview.preview.id, previewAccessToken: preview.accessToken!, planKey: 'site_geo_autopost', cadenceDays: 7, domainOption: 'new', domainTld: 'com', idempotencyKey: 'shopify-contract-quote-001' }, ordering.repository)
