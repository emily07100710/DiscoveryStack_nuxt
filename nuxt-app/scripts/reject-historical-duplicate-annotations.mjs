...
const duplicateAnnotations = [
  { artifactId: 990002, retainedArtifactId: 330002, sourceUrl: 'https://developers.google.com/search/docs/crawling-indexing/ask-google-to-recrawl?hl=en' },
  { artifactId: 510004, retainedArtifactId: 270004, sourceUrl: 'https://developers.google.com/search/docs/crawling-indexing/mobile/mobile-sites-mobile-first-indexing?hl=en' },
  { artifactId: 630002, retainedArtifactId: 270005, sourceUrl: 'https://developers.google.com/search/docs/essentials?hl=en' },
  { artifactId: 630001, retainedArtifactId: 390001, sourceUrl: 'https://developers.google.com/search/docs/fundamentals/ai-optimization-guide?hl=en' },
  { artifactId: 990001, retainedArtifactId: 390002, sourceUrl: 'https://developers.google.com/search/docs/monitor-debug/search-console-start?hl=en' },
]
...
for (const duplicate of duplicateAnnotations) {
  ...
  if (!artifact) throw new Error(`historical_duplicate_annotation_not_found:${duplicate.artifactId}`)
