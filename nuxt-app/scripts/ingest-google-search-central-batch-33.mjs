...
const requestedUrls = [
  'https://developers.google.com/search/docs/appearance/structured-data/recipe?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/software-app?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/carousel?hl=en',
