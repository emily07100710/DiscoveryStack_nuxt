...
const candidateUrls = [
  'https://developers.google.com/search/docs/appearance/structured-data/event?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/job-posting?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/video?hl=en',
]
