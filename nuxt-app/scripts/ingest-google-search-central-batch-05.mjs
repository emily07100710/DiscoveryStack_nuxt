...
const candidateUrls = [
  ...
  'https://developers.google.com/search/docs/appearance/structured-data/merchant-listing?hl=en',
...
}).from(publicIntelligenceSources).where(and(
