...
const requestedUrls = [
  'https://developers.google.com/search/docs/appearance/structured-data?hl=en',
  'https://developers.google.com/search/docs/appearance/preferred-sources?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/article?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/profile-page?hl=en',
  'https://developers.google.com/search/docs/appearance/structured-data/discussion-forum?hl=en',
