...
const form = reactive({
  ...
  message: '', privacyConsent: false, recontactConsent: false, companyFax: '',
})
...
const copy = computed(() => isZh.value ? {
  ...
  recontact: '可以在這次諮詢以外，寄送後續相關資訊給我。', submit: '送出合作諮詢', submitting: '正在送出…',
  ...
  recontact: 'You may send relevant follow-up information beyond this enquiry.', submit: 'Send fit-review request', submitting: 'Sending…',
