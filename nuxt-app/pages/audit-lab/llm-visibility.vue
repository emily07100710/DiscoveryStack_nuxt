...
<template>
  <div class="monitor">
    <header class="hero">
      ...
      <p class="lede">V1 runtime 只記錄 owner 人工核對的模型觀測，分清楚「看見了什麼」與「無法證明什麼」。這不是搜尋排名，也不代表 consumer ChatGPT／Gemini 介面的真實曝光。</p>
      <div class="truth-band"><strong>資料邊界</strong><span>無 scheduler</span><span>無 provider executor</span><span>無 consumer UI scraping</span><span>不儲存完整 response</span></div>
    </header>
