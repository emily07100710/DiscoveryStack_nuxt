...
const activeSection = computed(() => route.path === '/audit-lab/geo' ? 'geo' : route.path === '/audit-lab/seo-geo' ? 'core' : route.path === '/audit-lab/llm-visibility' ? 'visibility' : route.path === '/audit-lab/content-operations' ? 'content-operations' : route.path === '/audit-lab/measurement-operations' ? 'measurement' : 'audit')
