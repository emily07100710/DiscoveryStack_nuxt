...
export default defineEventHandler(async event => {
  ...
  return createExistingSiteRelease(ownerUserId, { projectId, canonicalDomain: String(body.canonicalDomain || ''), targetKey: String(body.targetKey || ''), idempotencyKey: String(body.idempotencyKey || '') }, { repository, managedRepository })
})
