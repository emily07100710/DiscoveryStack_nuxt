...
import { approveManagedSitePreview } from '../../../../../../managed-sites/live-connectors/deployment-orchestrator'
...
export default defineEventHandler(async event => {
  ...
  return approveManagedSitePreview(ownerUserId, { releaseId, idempotencyKey: String(body.idempotencyKey || '') }, repository)
})
