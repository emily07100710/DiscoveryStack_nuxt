...
import { createExistingSiteOwnershipChallenge } from '../../../../../../managed-sites/live-connectors/deployment-orchestrator'
...
export default defineEventHandler(async event => {
  ...
  return createExistingSiteOwnershipChallenge(ownerUserId, { releaseId, idempotencyKey: String(body.idempotencyKey || '') }, repository)
})
