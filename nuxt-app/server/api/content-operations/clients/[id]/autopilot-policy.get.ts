import { getOwnerAutopilotPolicy, toPublicContentOperationsError } from '../../../../content-operations'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    return await getOwnerAutopilotPolicy(ownerUserId, clientId)
  } catch (error) {
    throw toPublicContentOperationsError(error, 'Governed autopilot status is temporarily unavailable.')
  }
})
