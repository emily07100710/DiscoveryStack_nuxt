import { revokeOwnerAutopilot, toPublicContentOperationsError } from '../../../../content-operations'
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    return await revokeOwnerAutopilot(ownerUserId, clientId)
  } catch (error) {
    throw toPublicContentOperationsError(error, 'Governed autopilot revocation is temporarily unavailable.')
  }
})
