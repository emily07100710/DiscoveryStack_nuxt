...
export interface MediaStoragePort {
  ...
  completeUpload(input: MediaTenantScope & { objectKey: string }): Promise<MediaObjectHead>
...
export interface MediaSecurityScanner { scan(input: { bytes: Uint8Array; sha256: string; tenant: MediaTenantScope }): Promise<{ verdict: MediaScannerVerdict; reasonCode: string | null; scannerReference: string | null }> }
