...
export type WebsiteEditIntent = 'organize_case_studies' | 'refine_layout' | 'replace_hero' | 'normalize_service_images' | 'mobile_carousel_fallback' | 'schedule_campaign' | 'move_block' | 'undo' | 'freeform_edit' | 'bounded_clarification' | 'unrelated_refusal'
