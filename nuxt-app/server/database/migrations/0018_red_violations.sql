...
ALTER TABLE `contentOperationCalendarEntryTargets` ADD CONSTRAINT `contentOperationCalendarEntryTargets_clientId_contentOperationClients_id_fk` FOREIGN KEY (`clientId`) REFERENCES `contentOperationClients`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationCalendarEntryTargets` ADD CONSTRAINT `contentOperationCalendarEntryTargets_entryId_contentOperationCalendarEntries_id_fk` FOREIGN KEY (`entryId`) REFERENCES `contentOperationCalendarEntries`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationCalendarEntryTargets` ADD CONSTRAINT `contentOperationCalendarEntryTargets_targetId_contentOperationPublicationTargets_id_fk` FOREIGN KEY (`targetId`) REFERENCES `contentOperationPublicationTargets`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationEvents` ADD CONSTRAINT `contentOperationEvents_deliverableId_seoGeoProductionDeliverables_id_fk` FOREIGN KEY (`deliverableId`) REFERENCES `seoGeoProductionDeliverables`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationOutcomeAssessments` ADD CONSTRAINT `contentOperationOutcomeAssessments_targetId_contentOperationPublicationTargets_id_fk` FOREIGN KEY (`targetId`) REFERENCES `contentOperationPublicationTargets`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationOutcomeAssessments` ADD CONSTRAINT `contentOperationOutcomeAssessments_draftId_seoGeoContentDrafts_id_fk` FOREIGN KEY (`draftId`) REFERENCES `seoGeoContentDrafts`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
