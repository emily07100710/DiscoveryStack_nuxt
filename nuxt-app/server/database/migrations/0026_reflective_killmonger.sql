...
ALTER TABLE `managedSiteConnectorAttempts` ADD CONSTRAINT `managedSiteConnectorAttempts_draftOrderId_managedSiteDraftOrders_id_fk` FOREIGN KEY (`draftOrderId`) REFERENCES `managedSiteDraftOrders`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteConnectorAttempts` ADD CONSTRAINT `managedSiteConnectorAttempts_releaseId_managedSiteReleaseProjections_id_fk` FOREIGN KEY (`releaseId`) REFERENCES `managedSiteReleaseProjections`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteConnectorReceipts` ADD CONSTRAINT `managedSiteConnectorReceipts_draftOrderId_managedSiteDraftOrders_id_fk` FOREIGN KEY (`draftOrderId`) REFERENCES `managedSiteDraftOrders`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteConnectorReceipts` ADD CONSTRAINT `managedSiteConnectorReceipts_releaseId_managedSiteReleaseProjections_id_fk` FOREIGN KEY (`releaseId`) REFERENCES `managedSiteReleaseProjections`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteConnectorReceipts` ADD CONSTRAINT `managedSiteConnectorReceipts_attemptId_managedSiteConnectorAttempts_id_fk` FOREIGN KEY (`attemptId`) REFERENCES `managedSiteConnectorAttempts`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteGenerationCandidates` ADD CONSTRAINT `managedSiteGenerationCandidates_projectId_managedSiteProjects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `managedSiteProjects`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteGenerationCandidates` ADD CONSTRAINT `managedSiteGenerationCandidates_sourceVersionId_managedSiteVersions_id_fk` FOREIGN KEY (`sourceVersionId`) REFERENCES `managedSiteVersions`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteReleaseProjections` ADD CONSTRAINT `managedSiteReleaseProjections_projectId_managedSiteProjects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `managedSiteProjects`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteReleaseProjections` ADD CONSTRAINT `managedSiteReleaseProjections_generationCandidateId_managedSiteGenerationCandidates_id_fk` FOREIGN KEY (`generationCandidateId`) REFERENCES `managedSiteGenerationCandidates`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteReleaseProjections` ADD CONSTRAINT `managedSiteReleaseProjections_versionId_managedSiteVersions_id_fk` FOREIGN KEY (`versionId`) REFERENCES `managedSiteVersions`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
