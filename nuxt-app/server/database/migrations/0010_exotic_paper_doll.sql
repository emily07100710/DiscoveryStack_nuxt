...
ALTER TABLE `modelImprovementCandidates` ADD CONSTRAINT `modelImprovementCandidates_collectionRunId_modelImprovementCollectionRuns_id_fk` FOREIGN KEY (`collectionRunId`) REFERENCES `modelImprovementCollectionRuns`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `modelImprovementCandidates` ADD CONSTRAINT `modelImprovementCandidates_publicSourceId_publicIntelligenceSources_id_fk` FOREIGN KEY (`publicSourceId`) REFERENCES `publicIntelligenceSources`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `modelImprovementCandidates` ADD CONSTRAINT `modelImprovementCandidates_publicArtifactId_publicIntelligenceArtifacts_id_fk` FOREIGN KEY (`publicArtifactId`) REFERENCES `publicIntelligenceArtifacts`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
