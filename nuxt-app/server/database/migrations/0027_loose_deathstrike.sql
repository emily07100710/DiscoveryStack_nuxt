...
ALTER TABLE `managedSiteDomainClaims` ADD CONSTRAINT `fk_managed_site_domain_clai_release_id_6a2672e5b2` FOREIGN KEY (`releaseId`) REFERENCES `managedSiteReleaseProjections`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteGateResults` ADD CONSTRAINT `fk_managed_site_gate_result_generation_candida_7e2a8eba4c` FOREIGN KEY (`generationCandidateId`) REFERENCES `managedSiteGenerationCandidates`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteGateResults` ADD CONSTRAINT `fk_managed_site_gate_result_release_id_ed32aa98b4` FOREIGN KEY (`releaseId`) REFERENCES `managedSiteReleaseProjections`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSitePrePurchaseBindings` ADD CONSTRAINT `fk_managed_site_pre_purchas_project_id_17eb9d490b` FOREIGN KEY (`projectId`) REFERENCES `managedSiteProjects`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSitePrePurchaseBindings` ADD CONSTRAINT `fk_managed_site_pre_purchas_source_version_id_15a924e8a2` FOREIGN KEY (`sourceVersionId`) REFERENCES `managedSiteVersions`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSitePrePurchaseBindings` ADD CONSTRAINT `fk_managed_site_pre_purchas_preview_id_d7c83939e8` FOREIGN KEY (`previewId`) REFERENCES `managedSitePreviews`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSitePrePurchaseBindings` ADD CONSTRAINT `fk_managed_site_pre_purchas_draft_order_id_7d8b59829b` FOREIGN KEY (`draftOrderId`) REFERENCES `managedSiteDraftOrders`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteReleaseProjections` ADD CONSTRAINT `fk_managed_site_release_pro_preview_id_4b812a543b` FOREIGN KEY (`previewId`) REFERENCES `managedSitePreviews`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteReleaseProjections` ADD CONSTRAINT `fk_managed_site_release_pro_draft_order_id_0d8e68ef2b` FOREIGN KEY (`draftOrderId`) REFERENCES `managedSiteDraftOrders`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
