...
ALTER TABLE `managedSiteDomainIntents` ADD CONSTRAINT `managedSiteDomainIntents_draftOrderId_managedSiteDraftOrders_id_fk` FOREIGN KEY (`draftOrderId`) REFERENCES `managedSiteDraftOrders`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteProvisioningEvents` ADD CONSTRAINT `managedSiteProvisioningEvents_projectId_managedSiteProjects_id_fk` FOREIGN KEY (`projectId`) REFERENCES `managedSiteProjects`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteProvisioningEvents` ADD CONSTRAINT `managedSiteProvisioningEvents_planId_managedSiteProvisioningPlans_id_fk` FOREIGN KEY (`planId`) REFERENCES `managedSiteProvisioningPlans`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `managedSiteProvisioningEvents` ADD CONSTRAINT `managedSiteProvisioningEvents_stepId_managedSiteProvisioningSteps_id_fk` FOREIGN KEY (`stepId`) REFERENCES `managedSiteProvisioningSteps`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteProvisioningPlans` ADD CONSTRAINT `managedSiteProvisioningPlans_domainIntentId_managedSiteDomainIntents_id_fk` FOREIGN KEY (`domainIntentId`) REFERENCES `managedSiteDomainIntents`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `managedSiteProvisioningSteps` ADD CONSTRAINT `managedSiteProvisioningSteps_planId_managedSiteProvisioningPlans_id_fk` FOREIGN KEY (`planId`) REFERENCES `managedSiteProvisioningPlans`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
