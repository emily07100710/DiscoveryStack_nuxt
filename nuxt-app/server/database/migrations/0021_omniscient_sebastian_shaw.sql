...
ALTER TABLE `managedSiteProjects` ADD CONSTRAINT `managedSiteProjects_contentOperationClientId_contentOperationClients_id_fk` FOREIGN KEY (`contentOperationClientId`) REFERENCES `contentOperationClients`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
