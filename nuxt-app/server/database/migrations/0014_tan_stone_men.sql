...
ALTER TABLE `contentOperationCalendarEntries` ADD CONSTRAINT `contentOperationCalendarEntries_calendarId_contentOperationCalendars_id_fk` FOREIGN KEY (`calendarId`) REFERENCES `contentOperationCalendars`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationCalendarEntries` ADD CONSTRAINT `contentOperationCalendarEntries_productionDeliverableId_seoGeoProductionDeliverables_id_fk` FOREIGN KEY (`productionDeliverableId`) REFERENCES `seoGeoProductionDeliverables`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationCalendarEntries` ADD CONSTRAINT `contentOperationCalendarEntries_strategyRecommendationId_seoGeoStrategyRecommendations_id_fk` FOREIGN KEY (`strategyRecommendationId`) REFERENCES `seoGeoStrategyRecommendations`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationCalendarEntries` ADD CONSTRAINT `contentOperationCalendarEntries_draftId_seoGeoContentDrafts_id_fk` FOREIGN KEY (`draftId`) REFERENCES `seoGeoContentDrafts`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationCalendarEntries` ADD CONSTRAINT `contentOperationCalendarEntries_reviewId_seoGeoContentReviews_id_fk` FOREIGN KEY (`reviewId`) REFERENCES `seoGeoContentReviews`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationCalendars` ADD CONSTRAINT `contentOperationCalendars_productionPlanId_seoGeoProductionPlans_id_fk` FOREIGN KEY (`productionPlanId`) REFERENCES `seoGeoProductionPlans`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationEvents` ADD CONSTRAINT `contentOperationEvents_calendarId_contentOperationCalendars_id_fk` FOREIGN KEY (`calendarId`) REFERENCES `contentOperationCalendars`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationEvents` ADD CONSTRAINT `contentOperationEvents_entryId_contentOperationCalendarEntries_id_fk` FOREIGN KEY (`entryId`) REFERENCES `contentOperationCalendarEntries`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationOutcomeAssessments` ADD CONSTRAINT `contentOperationOutcomeAssessments_entryId_contentOperationCalendarEntries_id_fk` FOREIGN KEY (`entryId`) REFERENCES `contentOperationCalendarEntries`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `contentOperationOutcomeAssessments` ADD CONSTRAINT `contentOperationOutcomeAssessments_runId_contentOperationRuns_id_fk` FOREIGN KEY (`runId`) REFERENCES `contentOperationRuns`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `contentOperationRuns` ADD CONSTRAINT `contentOperationRuns_entryId_contentOperationCalendarEntries_id_fk` FOREIGN KEY (`entryId`) REFERENCES `contentOperationCalendarEntries`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
